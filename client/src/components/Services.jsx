...
const Services = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full justify-center items-center gradient-bg-services">
      ...
      <div className="flex-1 md:w-8/12 flex flex-col justify-start items-center">
        <ServiceCard
          color="bg-[#2952e3]"
          title="Security Guaranteed"
          icon={<BsShieldFillCheck fontSize={21} className="text-white" />}
          subtitle="Security is our main focus! We always maintain privacy and quality of our products."
        />
        <ServiceCard
          color="bg-[#8945F8]"
